...
type FriendCircle struct {
	Summary           []KVItem
	Peer_num_top_list []PeerNumTopList //联系人top
	Location_top_list []PeerNumTopList //通话地top
}
...
type TopItem struct {
	Peer_number     string //对方号码
	Dialed_time     string //被叫时长(秒)
	Call_cnt        string //通话次数
	Dial_cnt        string //主叫次数
	Dial_time       string
	Group_name      string //号码类型
	Dialed_cnt      string //被叫次数
	Company_name    string //号码标识
	Call_time       string //通话时长(秒)
	Peer_num_loc    string //通话地
	Location        string
	Peer_number_cnt string //通话号码数
}
...
type CallContactDetailItem struct { // 通话详单
	...
	Call_cnt_1m           string //近一月通话次数
	Dialed_cnt_6m         string //
	Call_cnt_afternoon_3m string //
	Company_name          string //号码标识
	Call_cnt_3m           string //近三月通话次数
	Call_cnt_noon_6m      string //
	Dial_time_6m          string //
	Dial_cnt_6m           string //
	Call_cnt_1w           string //近一周通话次数
	Call_time_6m          string //
	Trans_end             string //
	SignState             int
	SignRemark            string
...
type ReData struct {
	...
	Call_contact_detail   []CallContactDetailItem //通话详单
...
type Mxdata struct {
	...
	Mxyysdata MxyysdataInfo
}

type MxyysdataInfo struct {
	Calls []CallsInfo
}
...
type ItemsInfo struct {
	Time          string
	Dial_type     string //电话号码
	Dialtype      string //电话号码
	Peer_number   string //DIAL   被叫 DIALED 主叫
	Peernumber    string //DIAL   被叫 DIALED 主叫
	Location      string //归属地
	Duration      int    //联系时长
	Location_type string //通话类型
	Locationtype  string //通话类型
}
